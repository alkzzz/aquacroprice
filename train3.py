...
from aquacroprice.envs.wheat import Wheat
...
train_env = DummyVecEnv([lambda: Monitor(Wheat(mode='train', year1=1982, year2=2002))])
...
for name, model in algorithms.items():
    ...
    eval_env = DummyVecEnv([lambda: Monitor(Wheat(mode='eval', year1=2003, year2=2018))])
